...
public class xClockNtpMessage {
	 ...
	 */
	public xClockNtpMessage(final byte[] array) {
	...
	public static String timestampToString(final double timestamp) {
		...
		// date/time
		final String date = new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new Date(ms));

		// fraction
		final double fraction = timestamp - ((long) timestamp);
		final String fractionSting = new DecimalFormat(".000000").format(fraction);
